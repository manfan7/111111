...
(jQuery.easing.jswing = jQuery.easing.swing),
  jQuery.extend(jQuery.easing, {
    ...
    easeOutElastic: function (t, e, i, n, a) {
      ...
      return (
        s * Math.pow(2, -10 * e) * Math.sin(((e * a - r) * (2 * Math.PI)) / o) +
        n +
        i
      );
    },
    ...
    easeInOutBounce: function (t, e, i, n, a) {
      return e < a / 2
        ...
        : 0.5 * jQuery.easing.easeOutBounce(t, 2 * e - a, 0, n, a) +
            0.5 * n +
            i;
    },
  }),
        ...
        return (function (t, e, i, n) {
          ...
          function o(t, i, n, a) {
            ...
            function h() {
              (k = !0),
                (t != i || n != a) &&
                  (function () {
                    for (var e = 0; m > e; ++e) w[e] = l(e * b, t, n);
                  })();
            }
            var f = 4,
              p = 0.001,
            ...
            (t = Math.min(t, 1)),
              ...
              (t = Math.max(t, 0)),
              (n = Math.max(n, 0));
            var w = y ? new Float32Array(m) : new Array(m),
              k = !1,
              S = function (e) {
                return (
                  k || h(),
          ...
          function s(t, e) {
            ...
            return (
              f.isString(t)
                ? m.Easings[t] || (i = !1)
                : (i =
                    f.isArray(t) && 1 === t.length
                      ? function (t) {
                          return function (e) {
                            return Math.round(e * t) * (1 / t);
                          };
                        }.apply(null, t)
                      : f.isArray(t) && 2 === t.length
                      ? b.apply(null, t.concat([e]))
                      : !(!f.isArray(t) || 4 !== t.length) && o.apply(null, t)),
              !1 === i &&
                (i = m.Easings[m.defaults.easing] ? m.defaults.easing : v),
              i
            );
          }
          function l(t) {
            if (t) {
              ...
              for (var a = 0; i > a; a++)
                if (m.State.calls[a]) {
                  var o = m.State.calls[a],
                    s = o[0],
                    c = o[2],
                    h = o[3],
                    p = !!h,
                    g = null;
                  h || (h = m.State.calls[a][3] = e - 16);
                  for (
                    var v = Math.min((e - h) / c.duration, 1),
                      b = 0,
                      x = s.length;
                    x > b;
                    b++
                    ...
                    if (r(S)) {
                        ...
                        if ("element" !== M) {
                          ...
                          if (((A.currentValue = P), "tween" === M)) g = P;
                            ...
                            var F = y.setPropertyValue(
                              ...
                              M,
                              A.currentValue +
                                (0 === parseFloat(P) ? "" : A.unitType),
                              A.rootPropertyValue,
                              A.scrollData
                            );
                            y.Hooks.registered[M] &&
                              (r(S).rootPropertyValueCache[_] = y.Normalizations
                                .registered[_]
                                ? y.Normalizations.registered[_](
                                    "extract",
                                    null,
                                    F[1]
                                  )
                      ...
                      c.mobileHA &&
                        ...
                        ((r(S).transformCache.translate3d = "(0px, 0px, 0px)"),
                        (C = !0)),
                        C && y.flushTransformCache(S);
                    }
                  }
                  c.display !== n &&
                    "none" !== c.display &&
            ...
            m.State.isTicking && w(l);
          }
          function u(t, e) {
            if (!m.State.calls[t]) return !1;
            for (
              var i = m.State.calls[t][0],
                a = m.State.calls[t][1],
                o = m.State.calls[t][2],
                s = m.State.calls[t][4],
                l = !1,
              ...
              if (
                (e ||
                  o.loop ||
                  ("none" === o.display &&
                    y.setPropertyValue(h, "display", o.display),
                  "hidden" === o.visibility &&
                    y.setPropertyValue(h, "visibility", o.visibility)),
                !0 !== o.loop &&
                  (d.queue(h)[1] === n ||
                    !/\.velocityQueueEntryFlag/i.test(d.queue(h)[1])) &&
                  r(h))
              ) {
                ...
                d.each(y.Lists.transforms3D, function (t, e) {
                  ...
                  o.mobileHA &&
                    ((f = !0), delete r(h).transformCache.translate3d),
                  f && y.flushTransformCache(h),
                  y.Values.removeClass(h, "velocity-animating");
              }
              ...
              s && !0 !== o.loop && s(a),
                r(h) &&
                  !0 === o.loop &&
                  !e &&
                  (d.each(r(h).tweensContainer, function (t, e) {
                    /^rotate/.test(t) &&
                  ...
                  m(h, "reverse", { loop: !0, delay: o.delay })),
                !1 !== o.queue && d.dequeue(h, o.queue);
            }
            m.State.calls[t] = !1;
            for (var p = 0, g = m.State.calls.length; g > p; p++)
              if (!1 !== m.State.calls[p]) {
                l = !0;
                break;
              }
            !1 === l &&
          ...
          if (!(7 >= c)) {
            ...
            var y = (m.CSS = {
              ...
              Hooks: {
                ...
                cleanRootPropertyValue: function (t, e) {
                  return (
                    ...
                    y.Values.isCSSNullValue(e) && (e = y.Hooks.templates[t][1]),
                    e
                  );
                },
                ...
                injectValue: function (t, e, i) {
                  ...
                  if (n) {
                    var a,
                      ...
                      o = n[1];
                    return (
                      ((a = (i = y.Hooks.cleanRootPropertyValue(r, i))
                        .toString()
                        .match(y.RegEx.valueSplit))[o] = e),
                      a.join(" ")
                    );
                  }
                  return i;
                      ...
                      y.Normalizations.registered[e] = function (t, i, a) {
                        switch (t) {
                          ...
                          case "inject":
                            ...
                            return (
                              o || (r(i).transformCache[e] = "(" + a + ")"),
                              r(i).transformCache[e]
                            );
                        }
                      };
                    })();
                    ...
                    !(function () {
                      ...
                      y.Normalizations.registered[e] = function (t, i, a) {
                        switch (t) {
                          ...
                          case "extract":
                            var r;
                            if (y.RegEx.wrappedValueAlreadyExtracted.test(a))
                              r = a;
                            else {
                              var o,
                                s = {
              ...
              Names: {
                ...
                SVGAttribute: function (t) {
                  ...
                  return (
                    (c || (m.State.isAndroid && !m.State.isChrome)) &&
                      (e += "|transform"),
              ...
              getPropertyValue: function (t, i, a, o) {
                  ...
                  if (8 >= c) l = d.css(t, i);
                      ...
                      if (
                        ...
                        var f =
                          ...
                          (parseFloat(y.getPropertyValue(t, "paddingTop")) ||
                            0) -
                          (parseFloat(y.getPropertyValue(t, "paddingBottom")) ||
                            0);
                        return a(), f;
                      }
                      if (
                        ...
                        var p =
                          ...
                          (parseFloat(y.getPropertyValue(t, "paddingLeft")) ||
                            0) -
                          (parseFloat(y.getPropertyValue(t, "paddingRight")) ||
                            0);
                        return a(), p;
                      }
                    }
                    (u =
                      r(t) === n
                        ...
                        : r(t).computedStyle
                        ? r(t).computedStyle
                        : (r(t).computedStyle = e.getComputedStyle(t, null))),
                ...
                if (y.Hooks.registered[i]) {
                  var u = i,
                    h = y.Hooks.getRoot(u);
                  a === n &&
                    (a = y.getPropertyValue(t, y.Names.prefixCheck(h)[0])),
                    y.Normalizations.registered[h] &&
                      (a = y.Normalizations.registered[h]("extract", t, a)),
                    (l = y.Hooks.extractValue(u, a));
                } else if (y.Normalizations.registered[i]) {
                  var f, p;
                  "transform" !==
                    (f = y.Normalizations.registered[i]("name", t)) &&
              ...
              setPropertyValue: function (t, i, n, a, o) {
                ...
                if ("scroll" === i)
                  ...
                  "transform" === y.Normalizations.registered[i]("name", t)
                )
                  y.Normalizations.registered[i]("inject", t, n),
                    (s = "transform"),
                    (n = r(t).transformCache[i]);
                else {
                  if (y.Hooks.registered[i]) {
                    var l = i,
                      u = y.Hooks.getRoot(i);
                    (a = a || y.getPropertyValue(t, u)),
                      (n = y.Hooks.injectValue(l, n, a)),
                      (i = u);
                  }
                  if (
                    (y.Normalizations.registered[i] &&
              ...
              flushTransformCache: function (t) {
                ...
                if (
                  ...
                  d.each(r(t).transformCache, function (e) {
                    return (
                      (a = r(t).transformCache[e]),
                      "transformPerspective" === e
                        ? ((o = a), !0)
                        : (9 === c && "rotateZ" === e && (e = "rotate"),
                          void (i += e + a + " "))
                    );
                  }),
                    o && (i = "perspective" + o + " " + i);
            ...
            y.Hooks.register(),
              ...
              (m.hook = function (t, e, i) {
                var o = n;
                return (
                  (t = a(t)),
                  d.each(t, function (t, a) {
                    if ((r(a) === n && m.init(a), i === n))
                      o === n && (o = m.CSS.getPropertyValue(a, e));
                    else {
                      var s = m.CSS.setPropertyValue(a, e, i);
            ...
            var x = function () {
              ...
              function o() {
                function t(t) {
                        ...
                        ? ((i = t[0]),
                          ...
                          y.RegEx.isHex.test(t[1])
                            ...
                            : ((f.isString(t[1]) &&
                                !y.RegEx.isHex.test(t[1])) ||
                                f.isArray(t[1])) &&
                              ((a = e ? t[1] : s(t[1], u.duration)),
                              t[2] !== n && (r = t[2])))
                        : (i = t),
                      e || (a = a || u.easing),
                      f.isFunction(i) && (i = i.call(o, C, S)),
                      f.isFunction(r) && (r = r.call(o, C, S)),
                      [i || 0, a, r]
                    );
                  }
                  function p(t, e) {
                  ...
                  function g() {
                    ...
                    if (a && n)
                      ...
                      m.init(u),
                        ...
                        d.each(
                          ...
                          function (t, e) {
                            m.CSS.setPropertyValue(u, e, "hidden");
                          }
                        ),
                        m.CSS.setPropertyValue(u, "position", t.position),
                        m.CSS.setPropertyValue(u, "fontSize", t.fontSize),
                        m.CSS.setPropertyValue(u, "boxSizing", "content-box"),
                        d.each(
                          [
                            "minWidth",
                            "maxWidth",
                          ...
                          function (t, e) {
                            m.CSS.setPropertyValue(u, e, s + "%");
                          }
                        ),
                        m.CSS.setPropertyValue(u, "paddingLeft", s + "em"),
                        (l.percentToPxWidth = L.lastPercentToPxWidth =
                          (parseFloat(
                            y.getPropertyValue(u, "width", null, !0)
                          ) || 1) / s),
                        (l.percentToPxHeight = L.lastPercentToPxHeight =
                          (parseFloat(
                            y.getPropertyValue(u, "height", null, !0)
                          ) || 1) / s),
                        (l.emToPx = L.lastEmToPx =
                          (parseFloat(y.getPropertyValue(u, "paddingLeft")) ||
                            1) / s),
                    ...
                    return (
                      null === L.remToPx &&
                        (L.remToPx =
                          parseFloat(y.getPropertyValue(i.body, "fontSize")) ||
                          16),
                      null === L.vwToPx &&
                  ...
                  if ("scroll" === P) {
                    ...
                    u.container
                      ? f.isWrapped(u.container) || f.isNode(u.container)
                        ? ((u.container = u.container[0] || u.container),
                          (M =
                            (x = u.container["scroll" + T]) +
                            d(o).position()[T.toLowerCase()] +
                            I))
                        : (u.container = null)
                      : ((x =
                          m.State.scrollAnchor[m.State["scrollProperty" + T]]),
                        (k =
                          m.State.scrollAnchor[
                            m.State[
                      ...
                      m.debug &&
                        console.log("tweensContainer (scroll): ", c.scroll, o);
                  } else if ("reverse" === P) {
                    if (!r(o).tweensContainer)
                      return void d.dequeue(o, u.queue);
                    "none" === r(o).opts.display &&
                      (r(o).opts.display = "auto"),
                      "hidden" === r(o).opts.visibility &&
                        (r(o).opts.visibility = "visible"),
                      (r(o).opts.loop = !1),
                      (r(o).opts.begin = null),
                      (r(o).opts.complete = null),
                      w.easing || delete u.easing,
                      w.duration || delete u.duration,
                      (u = d.extend({}, r(o).opts, u));
                    var _ = d.extend(!0, {}, r(o).tweensContainer);
                    for (var D in _)
                      if ("element" !== D) {
                        var F = _[D].startValue;
                        (_[D].startValue = _[D].currentValue = _[D].endValue),
                          (_[D].endValue = F),
                          f.isEmptyObject(w) || (_[D].easing = u.easing),
                          m.debug &&
                            console.log(
                    ...
                    for (var O in (r(o).tweensContainer &&
                      !0 === r(o).isAnimating &&
                      (_ = r(o).tweensContainer),
                    d.each(b, function (t, e) {
                      if (
                        RegExp("^" + y.Lists.colors.join("$|^") + "$").test(t)
                      ) {
                        var i = h(e, !0),
                          a = i[0],
                          r = i[1],
                    ...
                    b)) {
                      ...
                      var E = y.Hooks.getRoot(O),
                        W = !1;
                      if (
                        r(o).isSVG ||
                        "tween" === E ||
                        !1 !== y.Names.prefixCheck(E)[1] ||
                        y.Normalizations.registered[E] !== n
                      ) {
                        ((u.display !== n &&
                          null !== u.display &&
                          "none" !== u.display) ||
                          (u.visibility !== n && "hidden" !== u.visibility)) &&
                          /opacity|filter/.test(O) &&
                          !B &&
                          0 !== z &&
                          (B = 0),
                          u._cacheValues && _ && _[O]
                            ? (B === n && (B = _[O].endValue + _[O].unitType),
                              (W = r(o).rootPropertyValueCache[E]))
                            : y.Hooks.registered[O]
                            ? B === n
                              ? ((W = y.getPropertyValue(o, E)),
                                (B = y.getPropertyValue(o, O, W)))
                              : (W = y.Hooks.templates[E][1])
                            : B === n && (B = y.getPropertyValue(o, O));
                        var H,
                          j,
                          q,
                          Y = !1;
                  ...
                  c.element &&
                    ...
                    R.push(c),
                    "" === u.queue &&
                      ((r(o).tweensContainer = c), (r(o).opts = u)),
                    (r(o).isAnimating = !0),
                    C === S - 1
                      ? (m.State.calls.push([R, v, u, null, A.resolver]),
                        !1 === m.State.isTicking &&
                          ((m.State.isTicking = !0), l()))
                      : C++);
                }
                var a,
                  o = this,
                  u = d.extend({}, m.defaults, w),
                  c = {};
                switch (
                  (r(o) === n && m.init(o),
                  parseFloat(u.delay) &&
                    !1 !== u.queue &&
                    d.queue(o, u.queue, function (t) {
                ...
                !1 !== m.mock &&
                  (!0 === m.mock
                    ...
                    : ((u.duration *= parseFloat(m.mock) || 1),
                      (u.delay *= parseFloat(m.mock) || 1))),
                  (u.easing = s(u.easing, u.duration)),
                  u.begin && !f.isFunction(u.begin) && (u.begin = null),
                  u.progress &&
                  ...
                  u.display !== n &&
                    ...
                    "auto" === u.display &&
                      (u.display = m.CSS.Values.getDisplayType(o))),
                  u.visibility !== n &&
                    null !== u.visibility &&
                    (u.visibility = u.visibility.toString().toLowerCase()),
                  (u.mobileHA =
                    u.mobileHA && m.State.isMobile && !m.State.isGingerbread),
                  !1 === u.queue
                    ? u.delay
                      ? setTimeout(t, u.delay)
                      : t()
                    : d.queue(o, u.queue, function (e, i) {
                        return !0 === i
                          ? (A.promise && A.resolver(v), !0)
                          : ((m.velocityQueueEntryFlag = !0), void t());
                      }),
                  ("" !== u.queue && "fx" !== u.queue) ||
              ...
              if (
                  ...
                  for (var M = p + 1; M < arguments.length; M++)
                    ...
                    (!/^(fast|normal|slow)$/i.test(arguments[M]) &&
                      ...
                      ? f.isString(arguments[M]) || f.isArray(arguments[M])
                        ...
                        : f.isFunction(arguments[M]) &&
                          (w.complete = arguments[M])
                ...
                switch (
                  (c &&
                    m.Promise &&
                    (A.promise = new m.Promise(function (t, e) {
                  ...
                  case "stop":
                    ...
                    return (
                      d.each(m.State.calls, function (t, e) {
                        e &&
                          d.each(e[1], function (i, a) {
                            var o = w === n ? "" : w;
                            return (
                              (!0 !== o &&
                                e[2].queue !== o &&
                                (w !== n || !1 !== e[2].queue)) ||
                              void d.each(v, function (i, n) {
                                n === a &&
                                  ((!0 === w || f.isString(w)) &&
                                    (d.each(
                  ...
                  default:
                    if (!d.isPlainObject(b) || f.isEmptyObject(b)) {
                        ...
                        return (
                          ...
                          d.each(v, function (t, e) {
                            parseFloat(O.stagger)
                              ? (O.delay = _ + parseFloat(O.stagger) * t)
                              : f.isFunction(O.stagger) &&
                                (O.delay = _ + O.stagger.call(e, t, S)),
                              O.drag &&
                                ((O.duration =
                                  parseFloat(I) ||
                                  (/^(callout|transition)/.test(b) ? 1e3 : g)),
                                (O.duration = Math.max(
                                  O.duration *
                                    (O.backwards ? 1 - t / S : (t + 1) / S),
                                  0.75 * O.duration,
                                  200
                                ))),
                              m.Redirects[b].call(
                      ...
                      return (
                        A.promise ? A.rejecter(new Error(D)) : console.log(D),
                        t()
                      );
                    }
                    P = "start";
                ...
                if (
                  ...
                  ((O = d.extend({}, m.defaults, w)).loop = parseInt(O.loop)),
                  (F = 2 * O.loop - 1),
                  O.loop)
                )
                  for (var V = 0; F > V; V++) {
                    var z = { delay: O.delay, progress: O.progress };
                    V === F - 1 &&
                      ((z.display = O.display),
                      (z.visibility = O.visibility),
            ...
            return (
              ...
              (t.Velocity = m),
              t !== e &&
                ((t.fn.velocity = x), (t.fn.velocity.defaults = m.defaults)),
              d.each(["Down", "Up"], function (t, e) {
                m.Redirects["slide" + e] = function (t, i, a, r, o, s) {
                  var l = d.extend({}, i),
                    u = l.begin,
                    c = l.complete,
                    h = {
              ...
              d.each(["In", "Out"], function (t, e) {
                m.Redirects["fade" + e] = function (t, i, a, r, o, s) {
                  var l = d.extend({}, i),
                    u = { opacity: "In" === e ? 1 : 0 },
                    c = l.complete;
                  (l.complete =
                ...
                callbacks: {
                  ...
                  label: function (t, e) {
                    var i = e.labels[t.index],
                      n = ": " + e.datasets[t.datasetIndex].data[t.index];
                    return (
                      r.isArray(i) ? ((i = i.slice())[0] += n) : (i += n), i
                    );
                  },
                },
              },
                  ...
                  t.DatasetController.extend({
                    ...
                    update: function (t) {
                      ...
                      if (f < 2 * Math.PI) {
                        ...
                        (u = Math.min(s / M.width, l / M.height)),
                          (d = {
                            x: -0.5 * (C.x + S.x),
                            y: -0.5 * (C.y + S.y),
                          });
                ...
                t.controllers.line = t.DatasetController.extend({
                  ...
                  updateElement: function (t, e, i) {
                    ...
                    void 0 !== u.radius &&
                      ...
                      (a = i ? h.getBasePixel() : o.calculatePointY(c, e, d)),
                      (t._xScale = f),
                      (t._yScale = h),
                      (t._datasetIndex = d),
                      (t._index = e),
                      (t._model = {
                        ...
                        radius:
                          l.radius ||
                          r.valueAtIndexOrDefault(u.pointRadius, e, p.radius),
                        pointStyle:
                          l.pointStyle ||
                          r.valueAtIndexOrDefault(
                            u.pointStyle,
                  ...
                  update: function (t) {
                    ...
                    (i.outerRadius = Math.max((l - s.borderWidth / 2) / 2, 0)),
                      ...
                      (i.radiusLength =
                        ...
                        i.getVisibleDatasetCount()),
                      (e.outerRadius =
                        i.outerRadius - i.radiusLength * e.index),
                  ...
                  updateElement: function (t, e, i) {
                    for (
                      var n = this,
                        ...
                        u = a.scale,
                        d = a.data.labels,
                        c = n.calculateCircumference(o.data[e]),
                        h = u.xCenter,
                        f = u.yCenter,
                        p = 0,
                        g = n.getMeta(),
                      ...
                      isNaN(o.data[v]) || g.data[v].hidden || ++p;
                    var m = s.startAngle,
                      b = t.hidden
                        ? 0
                    ...
                    r.extend(t, {
                      ...
                      _model: {
                        ...
                        innerRadius: 0,
                        outerRadius: i ? w : b,
                        startAngle: i && l.animateRotate ? m : y,
                        endAngle: i && l.animateRotate ? m : x,
                ...
                (t.Animation = a.extend({
                  ...
                  (t.animationService = {
                    ...
                    requestAnimationFrame: function () {
                      var t = this;
                      null === t.request &&
                        (t.request = r.requestAnimFrame.call(
                          window,
                          function () {
                ...
                if (t) {
                  ...
                  n.each(h.concat(f, p, g), function (t) {
                    var e,
                      i = t.isHorizontal();
                    i
                      ? ((e = t.update(t.fullWidth ? m : k, w)),
                        (S -= e.height))
                      : ((e = t.update(x, S)), (k -= e.width)),
                      C.push({ horizontal: i, minSize: e, box: t });
                  });
                  var M = 0,
                    P = 0,
                    A = 0,
                  ...
                  n.each(h.concat(f), B),
                    ...
                    n.each(h.concat(f), function (t) {
                      var e = n.findNextWhere(C, function (e) {
                        ...
                        i = { left: 0, right: 0, top: D, bottom: F };
                ...
                function B(t) {
                  ...
                  if (e)
                    if (t.isHorizontal()) {
                      ...
                      t.update(t.fullWidth ? m : k, b / 2, i);
                    } else t.update(e.minSize.width, S);
                }
                function E(t) {
                  t.isHorizontal()
                    ? ((t.left = t.fullWidth ? l : I),
                      (t.right = t.fullWidth ? e - u : I + k),
                      (t.top = N),
                      (t.bottom = N + t.height),
                      (N = t.bottom))
                    : ((t.left = z),
              ...
              (e.exports = function (t) {
                ...
                t.Scale = a.extend({
                  ...
                  beforeTickToLabelConversion: function () {
                    r.callback(this.options.beforeTickToLabelConversion, [
                      this,
                    ]);
                  },
                  ...
                  beforeCalculateTickRotation: function () {
                    r.callback(this.options.beforeCalculateTickRotation, [
                      this,
                    ]);
                  },
                  calculateTickRotation: function () {
                    ...
                    if (a.length && t.options.display && t.isHorizontal())
                      for (
                        ...
                        var f = r.toRadians(l);
                        if (
                          ((u = Math.cos(f)), Math.sin(f) * d > t.maxHeight)
                        ) {
                          l--;
                          break;
                        }
                  ...
                  fit: function () {
                    ...
                    if (
                      ((n.width = f
                        ...
                        ? g
                        : 0),
                      (n.height = f ? (h && c.drawTicks ? g : 0) : t.maxHeight),
                      d.display && h)
                    ) {
                      var v = o(d) + r.options.toPadding(d.padding).height;
                    ...
                    if (u.display && h) {
                      ...
                      if (f) {
                        ...
                        var w = r.toRadians(t.labelRotation),
                          k = Math.cos(w),
                          S = Math.sin(w) * m + p.size * b + y * (b - 1) + y;
                        ...
                        0 !== t.labelRotation
                          ? ((t.paddingLeft =
                              "bottom" === l.position ? k * C + 3 : k * y + 3),
                            (t.paddingRight =
                              "bottom" === l.position ? k * y + 3 : k * M + 3))
                          : ((t.paddingLeft = C / 2 + 3),
                            (t.paddingRight = M / 2 + 3));
                      } else
                        u.mirror ? (m = 0) : (m += x + y),
                          (n.width = Math.min(t.maxWidth, n.width + m)),
                    ...
                    if (a.display) {
                      ...
                      if (
                        (r.each(v, function (i, n) {
                          if (!r.isNullOrUndef(i.label)) {
                            ...
                            a.offset === h.offsetGridLines
                              ...
                              : ((o = r.valueAtIndexOrDefault(h.lineWidth, n)),
                                (s = r.valueAtIndexOrDefault(h.color, n)),
                                (c = r.valueOrDefault(
                                  h.borderDash,
                                  u.borderDash
                                )),
                            ...
                            if (g) {
                              ...
                              var E = l(
                                e,
                                n,
                                h.offsetGridLines && v.length > 1
                              );
                              E < e.left && (s = "rgba(0,0,0,0)"),
                                (E += r.aliasPixel(o)),
                              ...
                              d.mirror
                                ? ((V = H ? "left" : "right"), (W = N))
                                : ((V = H ? "right" : "left"), (W = w + N)),
                                (O = H ? e.right - W : e.left + W);
                              var j = l(
                                e,
                                n,
                                h.offsetGridLines && v.length > 1
                              ...
                              j < e.top && (s = "rgba(0,0,0,0)"),
                                (j += r.aliasPixel(o)),
                                (L = e.getPixelForTick(n) + d.labelOffset),
                                (m = T),
                                (y = I),
                                (k = t.left),
                                (C = t.right + A),
                        ...
                        if (g)
                          ...
                          (F = V ? e.left + R + C.top : e.right - R - C.top),
                            (O = e.top + (e.bottom - e.top) / 2),
                            (L = V ? -0.5 * Math.PI : 0.5 * Math.PI);
                        }
                        s.save(),
                          s.translate(F, O),
                          s.rotate(L),
                      ...
                      if (h.drawBorder) {
                        (s.lineWidth = r.valueAtIndexOrDefault(h.lineWidth, 0)),
                          (s.strokeStyle = r.valueAtIndexOrDefault(h.color, 0));
                        var z = e.left,
                          N = e.right + A,
                          B = e.top,
                          E = e.bottom + A,
                          W = r.aliasPixel(s.lineWidth);
                        g
                          ? ((B = E = "top" === a.position ? e.bottom : e.top),
                            (B += W),
                            (E += W))
                          : ((z = N = "left" === a.position ? e.right : e.left),
                            (z += W),
                            (N += W)),
                          s.beginPath(),
                          s.moveTo(z, B),
                ...
                (t.Tooltip = a.extend({
                  ...
                  update: function (e) {
                    ...
                    if (g.length) {
                      ...
                      var w = [],
                        k = [];
                      x = t.Tooltip.positioners[h.position].call(
                        c,
                        g,
                        c._eventPosition
                      );
                      ...
                      h.filter &&
                        ...
                        r.each(S, function (t) {
                          w.push(h.callbacks.labelColor.call(c, t, c._chart)),
                            k.push(
                              h.callbacks.labelTextColor.call(c, t, c._chart)
                            );
                        }),
                        (p.title = c.getTitle(S, v)),
                        (p.beforeBody = c.getBeforeBody(S, v)),
                        (p.body = c.getBody(S, v)),
                        (p.afterBody = c.getAfterBody(S, v)),
                        (p.footer = c.getFooter(S, v)),
                        (p.x = Math.round(x.x)),
                        (p.y = Math.round(x.y)),
                        ...
                        (b = (function (t, e, i, n) {
                          ...
                          return (
                            ...
                            "top" === d
                              ? (r += c)
                              : (r -=
                                  "bottom" === d ? e.height + c : e.height / 2),
                            "center" === d
                              ? "left" === u
                                ? (a += c)
                                : "right" === u && (a -= c)
                          ...
                          (y = (function (t, e) {
                            ...
                            return (
                              ...
                              r.each(e.beforeBody.concat(e.afterBody), p),
                          ...
                          (m = (function (t, e) {
                            ...
                            "center" === c
                              ...
                              i(s.x)
                                ? ((d = "left"),
                                  a(s.x) && ((d = "center"), (c = o(s.y))))
                                : n(s.x) &&
                                  ((d = "right"),
                                  r(s.x) && ((d = "center"), (c = o(s.y))));
                            var p = t._options;
                            return {
                ...
                draw: function () {
                  ...
                  for (
                    this._loop && u.length && u.push(u[0]),
                      ...
                      s.lineDashOffset =
                        a.borderDashOffset || d.borderDashOffset,
              ...
              (e.exports = a.extend({
                draw: function () {
                  ...
                  var v = [
                    ...
                    m = ["bottom", "left", "top", "right"].indexOf(o, 0);
                  function b(t) {
                    return v[(m + t) % 4];
                  }
                  -1 === m && (m = 0);
                    ...
                    switch (e) {
                      ...
                      case "rectRounded":
                        var c = i / Math.SQRT2,
                          ...
                          p = Math.SQRT2 * i;
                        t.beginPath(),
                          this.roundedRect(t, h, f, p, p, i / 2),
                          t.closePath(),
                          t.fill();
                        break;
                      case "rectRot":
          ...
          function (t, e, i) {
            ...
            function g(t, e, i) {
              ...
              !(function (t, e) {
                ...
                if (g.resizer) {
                  var e = t.parentNode;
                  e && e !== v.parentNode && e.insertBefore(v, e.firstChild),
                    v._reset();
                }
              });
            }
                  ...
                  u &&
                    ...
                    (function (t, e, i, n, a, r) {
                      ...
                      for (t.beginPath(), o = 0, s = g + !!r; o < s; ++o)
                        (d = i((u = e[(l = o % g)]._view), l, n)),
                          (f = c(u)),
                          (p = c(d)),
                          f && p
                            ? ((y = m.push(u)), (x = b.push(d)))
                            : y &&
                              x &&
                              (v
                                ? (f && m.push(u), p && b.push(d))
                                : (h(t, m, b, y, x),
                                  (y = x = 0),
                                  (m = []),
                                  (b = [])));
          ...
          function (t, e, i) {
            ...
            var u = a.extend({
              ...
              fit: function () {
                ...
                if (
                  (v
                    ? ((g.width = t.maxWidth), (g.height = a ? 10 : 0))
                    : ((g.width = a ? 10 : 0), (g.height = t.maxHeight)),
                  a)
                )
                  if (((o.font = f), v)) {
                    ...
                    (o.textAlign = "left"),
                      ...
                      r.each(t.legendItems, function (e, n) {
                        ...
                        m[m.length - 1] + a + i.padding >= t.width &&
                          ((b += d + i.padding), (m[m.length] = t.left)),
                          (p[n] = { left: 0, top: 0, width: a, height: d }),
                    ...
                    r.each(t.legendItems, function (t, e) {
                      ...
                      S + C > g.height &&
                        ((w += k + i.padding), x.push(k), (k = 0), (S = 0)),
                        (k = Math.max(k, n)),
                        (S += C),
                        (p[e] = { left: 0, top: 0, width: n, height: d });
                    }),
                      (w += k),
                      x.push(k),
                      (g.width += w);
                  ...
                  r.each(t.legendItems, function (n, l) {
                    ...
                    x
                      ? v + g >= s &&
                        ((m = d.y += w),
                        d.line++,
                        (v = d.x = t.left + (s - u[d.line]) / 2))
                      : m + w > t.bottom &&
                        ((v = d.x = v + t.columnWidths[d.line] + i.padding),
                        (m = d.y = t.top + i.padding),
                        d.line++),
                      (function (t, i, n) {
                        if (!(isNaN(b) || b <= 0)) {
                          c.save(),
                            (c.fillStyle = h(n.fillStyle, a.defaultColor)),
                            (c.lineCap = h(n.lineCap, o.borderCapStyle)),
                            (c.lineDashOffset = h(
                              n.lineDashOffset,
                              o.borderDashOffset
                            )),
                            (c.lineJoin = h(n.lineJoin, o.borderJoinStyle)),
                            (c.lineWidth = h(n.lineWidth, o.borderWidth)),
                            (c.strokeStyle = h(n.strokeStyle, a.defaultColor));
                          var s = 0 === h(n.lineWidth, o.borderWidth);
                          if (
                            (c.setLineDash &&
                              c.setLineDash(h(n.lineDash, o.borderDash)),
              ...
              draw: function () {
                ...
                if (a.display) {
                  var s,
                    ...
                    y = t.bottom,
                    x = t.right;
                  (e.fillStyle = i(a.fontColor, o.defaultFontColor)),
                    (e.font = f),
                    t.isHorizontal()
                      ? ((l = b + (x - b) / 2), (u = m + g), (s = x - b))
                      : ((l = "left" === a.position ? b + g : x - g),
                        (u = m + (y - m) / 2),
                        (s = y - m),
                        (v = Math.PI * ("left" === a.position ? -0.5 : 0.5))),
                    e.save(),
                    e.translate(l, u),
                    e.rotate(v),
                    (e.textAlign = "center"),
                    ...
                    var t = this,
                      ...
                      r = (t.ticks = (function (t, e) {
                        var i,
                          ...
                          s = o(
                            t.min,
                            Math.pow(10, Math.floor(n.log10(e.min)))
                          ),
                    ...
                    ? (function (t) {
                        ...
                        for (e = 0; e < g; e++) {
                          ...
                          var v = t.getIndexAngle(e),
                            m = a.toDegrees(v) % 360,
                            b = l(m, n.x, i.w, 0, 180),
                            y = l(m, n.y, i.h, 90, 270);
                          b.start < d.l && ((d.l = b.start), (c.l = v)),
                            b.end > d.r && ((d.r = b.end), (c.r = v)),
                            y.start < d.t && ((d.t = y.start), (c.t = v)),
                            y.end > d.b && ((d.b = y.end), (c.b = v));
                        }
                ...
                draw: function () {
                  ...
                  if (i.display) {
                    var h = t.ctx,
                      ...
                      v = l(r.fontFamily, e.defaultFontFamily),
                      m = a.fontString(p, g, v);
                    a.each(t.ticks, function (i, s) {
                      if (s > 0 || r.reverse) {
                        ...
                        if (
                          ...
                          if (
                            ...
                            (h.fillStyle = r.backdropColor),
                              h.fillRect(
                                -c / 2 - r.backdropPaddingX,
                                -u - p / 2 - r.backdropPaddingY,
                                c + 2 * r.backdropPaddingX,
                                p + 2 * r.backdropPaddingY
                              );
                          }
                          (h.textAlign = "center"),
                      ...
                      (i.angleLines.display || i.pointLabels.display) &&
                        (function (t) {
                          ...
                          var h = t.getDistanceFromCenterForValue(
                          ...
                          for (var p = o(t) - 1; p >= 0; p--) {
                            ...
                            if (l.display) {
                              ...
                              var b = t.getIndexAngle(p),
                                y = a.toDegrees(b);
                              (i.textAlign = u(y)),
                                c(y, t._pointLabelSizes[p], v),
                                d(i, t.pointLabels[p] || "", v, f.size);
                            }
                          }
                        })(t);
                  }
          ...
          function (t, e, i) {
            ...
            function h(t, e, i, n) {
              var a = (function (t, e, i) {
                  for (
                    var n, a, r, o = 0, s = t.length - 1;
                    o >= 0 && o <= s;

                  ) {
                    if (
                      ((a = t[(n = (o + s) >> 1) - 1] || null), (r = t[n]), !a)
                    )
                      return { lo: null, hi: r };
                    if (r[e] < i) o = n + 1;
                    else {
            ...
            function v(t, e, i, a) {
              ...
              for (
                f ||
                  ...
                  b = b.startOf(p ? "day" : c),
                  (y = y.startOf(p ? "day" : c)) < e && y.add(1, c),
                  o = n(b),
                  v &&
                    h &&
                    !p &&
                    !d.round &&
                    (o.startOf(h), o.add(~~((b - o) / (m.size * f)) * f, c));
                o < y;
                o.add(f, c)
              )
                x.push(+o);
              ...
              var e = t.Scale.extend({
                ...
                determineDataLimits: function () {
                  ...
                  w.length &&
                    ((w = c(w).sort(d)),
                    (m = Math.min(m, w[0])),
                    (b = Math.max(b, w[w.length - 1]))),
                    y.length &&
                      ((y = c(y).sort(d)),
                      (m = Math.min(m, y[0])),
                      (b = Math.max(b, y[y.length - 1]))),
                    (m = p(g.min, h) || m),
                    (b = p(g.max, h) || b),
                    (m = m === s ? +n().startOf(v) : m),
                    (b = b === o ? +n().endOf(v) + 1 : b),
                    (h.min = Math.min(m, b)),
                    (h.max = Math.max(m + 1, b)),
                ...
                buildTicks: function () {
                  ...
                  switch (s.ticks.source) {
                    ...
                    case "auto":
                    default:
                      c = v(r, o, a.getLabelCapacity(r), s);
                  }
                  for (
                    "ticks" === s.bounds &&
                      c.length &&
                      ((r = c[0]), (o = c[c.length - 1])),
                      r = p(d.min, a) || r,
                      o = p(d.max, a) || o,
                      t = 0,
                      e = c.length;
                  ...
                  return (
                    ...
                    (a._unit =
                      ...
                      })(m, d.minUnit, a.min, a.max)),
                    (a._majorUnit = g(a._unit)),
                    (a._table = (function (t, e, i, n) {
                      ...
                      return u;
                    })(a._timestamps.data, r, o, s.distribution)),
                    (a._offsets = (function (t, e, i, n, a) {
                      var r,
                        o,
                        s = 0,
                        l = 0;
                ...
                tickFormatFunction: function (t, e, i, n) {
                  var a = this.options,
                    ...
                    p = t.format(n || (f ? d : l)),
                    g = f ? h : a.ticks.minor,
                    v = r.valueOrDefault(g.callback, g.userCallback);
                  return v ? v(p, e, i) : p;
                },
        ...
        init: function () {
            ...
            t(".wow").each(function () {
              if (
                ...
                ((i + n - 100 > a(this) && n < a(this)) ||
                  (i + n - 100 > a(this) + t(this).height() &&
                    n < a(this) + t(this).height()) ||
                  (i + n == t(document).height() &&
                    a(this) + 100 > t(document).height()))
              ) {
                ...
                if (o) {
                  ...
                  t(s).addClass("animated"),
                    t(s).css({ visibility: "visible" }),
                    t(s).css({ "animation-delay": o }),
          ...
          t(".wow").each(function () {
            t(this).css({ visibility: "hidden" }),
              ...
              t(this).css({ "animation-name": "none" });
          }),
                ...
                ? ((e = window.innerHeight),
                  ...
                  t(".wow.animated").each(function () {
                    if (
                      ...
                      var i =
                        1e3 * t(this).css("animation-duration").slice(0, -1);
                      t(this).attr("data-wow-delay") &&
                        (i +=
                          1e3 * t(this).attr("data-wow-delay").slice(0, -1));
                      var n = this;
                      setTimeout(function () {
    ...
    return (
      ...
      (t.attach = function (t, e) {
        ...
        for (var o = 0, s = t.length; o < s; o++)
          (a = (n = t[o]).tagName.toLowerCase()),
            -1 !== ["input", "img"].indexOf(a) &&
              (u[a](n), (n = n.parentElement)),
      ...
      (t.calm = function (t) {
        for (
          var e = { type: "mouseup", button: 1 }, i = 0, n = (t = r(t)).length;
          i < n;
          i++
        )
          l.hide(e, t[i]);
  ...
  (function (t) {
      ...
      a = function () {
        ...
        if (e.val().length) {
          ...
          i.html(r),
            i.css(
              "width",
              e.is(":visible") ? e.width() : t(window).width() / 2
            ),
    ...
    t(e).each(function (e, n) {
      ...
      (function () {
        var e = t(".md-textarea-auto");
        if (e.length) {
          var i = void 0;
          (i = window.attachEvent
            ? function (t, e, i) {
    ...
    if (!t(".hiddendiv").first().length) {
      var o = t('<div class="hiddendiv common"></div>');
      r.append(o);
    }
    t(".materialize-textarea").each(a),
      r.on("keyup keydown", ".materialize-textarea", a);
  })(
    jQuery
  ) /*,jQuery("body").on("shown.bs.modal",".modal",function($){$(".modal-backdrop").length||($modal_dialog=$(this).children(".modal-dialog"),$modal_dialog.hasClass("modal-side")&&($(this).addClass("modal-scrolling"),jQuery("body").addClass("scrollable")),$modal_dialog.hasClass("modal-frame")&&($(this).addClass("modal-content-clickable"),jQuery("body").addClass("scrollable")))}),jQuery("body").on("hidden.bs.modal",".modal",function($){$("body").removeClass("scrollable")})*/;
