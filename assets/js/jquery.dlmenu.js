...
;( function( $, window, undefined ) {
	...
	$.DLMenu.prototype = {
		_init : function( options ) {
			...
			// Кэшируем и инициализируем некоторые элементы, а так же переменные
			this._config();
			...
			// Определение имени анимации которая будет видна в конце работы
			this.animEndEventName = animEndEventNames[ Modernizr.prefixed( 'animation' ) ] + '.dlmenu';
			// Определение имени перехода который будет виден в конце работы
			this.transEndEventName = transEndEventNames[ Modernizr.prefixed( 'transition' ) ] + '.dlmenu',
			// Проверка поддержки анимации и переходов
		...
		_config : function() {
			...
			this.$back = this.$menu.find( 'li a.dl-back' );
		},
		...
		// сброс меню в исходное состояние (первый уровень опций)
		_resetMenu : function() {
